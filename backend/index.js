...
async function connectDB(){
    let client=new MongoClient("mongodb+srv://Asha:petroleo@pruebas.1e0thqh.mongodb.net/")
...
app.get("/tickets", async (request, response)=>{
    try{
        ...
        let authData=await db.collection("Usuarios").findOne({"nombre": verifiedToken.nombre})
        let parametersFind={}
        if(authData.rol=="nacional"){
            parametersFind["nombre"]=verifiedToken.nombre;
        }
